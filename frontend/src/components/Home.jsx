    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <strong>How to Play:</strong> Use WASD keys to move around the store, mouse to look around. Walk into items to collect them. Find all items before time runs out!
        </div>
      </div>
    </div>
  );
